...
var _class = function () {
    ...
    _createClass(_class, null, [{
        ...
        value: async function getKadala() {
            var cache = await _redis2.default.getAsync('leah-kadala');
            ...
            await _redis2.default.set('leah-kadala', JSON.stringify([items, kadala.ItemTypes, kadala.Types, kadala.Classes]), 'EX', 86400);
