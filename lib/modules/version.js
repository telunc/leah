...
var _class = function () {
    ...
    _createClass(_class, null, [{
        ...
        value: async function getVersion() {
            var cacheVersion = await _redis2.default.getAsync('version');
            ...
            var version = results.versions[Object.keys(results.versions)[Object.keys(results.versions).length - 1]];
            await _redis2.default.set('version', JSON.stringify(version), 'EX', 86400);
            return version;
        }
    }]);
