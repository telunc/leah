...
var _class = function () {
    ...
    _createClass(_class, null, [{
        ...
        value: async function getSkills() {
            var cacheSkills = await _redis2.default.getAsync('skills');
            if (cacheSkills) return JSON.parse(cacheSkills);
            var results = await (0, _requestPromise2.default)({ uri: 'http://d3planner.com/game/json/powers', gzip: true, json: true }).catch(function () {
            ...
            await _redis2.default.set('skills', JSON.stringify(skills), 'EX', 86400);
            return skills;
        }
    }, {
