...
export default async(tokens, message) => {
    ...
    let stats = '';
    if (hero.stats.life && hero.stats.life !== 0) stats += `Life: ${hero.stats.life}\n`;
    if (hero.stats.damage && hero.stats.damage !== 0) stats += `Damage: ${hero.stats.damage}\n`;
    if (hero.stats.toughness && hero.stats.toughness !== 0) stats += `Toughness: ${hero.stats.toughness}\n`;
    if (hero.stats.healing && hero.stats.healing !== 0) stats += `Healing: ${hero.stats.healing}\n`;
    if (hero.stats.attackSpeed && hero.stats.attackSpeed !== 0) stats += `Attack Speed: ${hero.stats.attackSpeed.toFixed(2)}\n`;
    if (hero.stats.armor && hero.stats.armor !== 0) stats += `Armor: ${hero.stats.armor}\n`;
    if (hero.stats.strength && hero.stats.strength !== 0) stats += `Strength: ${hero.stats.strength}\n`;
    if (hero.stats.dexterity && hero.stats.dexterity !== 0) stats += `Dexterity: ${hero.stats.dexterity}\n`;
    if (hero.stats.vitality && hero.stats.vitality !== 0) stats += `Vitality: ${hero.stats.vitality}\n`;
    if (hero.stats.intelligence && hero.stats.intelligence !== 0) stats += `Intelligence: ${hero.stats.intelligence}\n`;
    if (hero.stats.physicalResist && hero.stats.physicalResist !== 0) stats += `Physical Resist: ${hero.stats.physicalResist}\n`;
    if (hero.stats.fireResist && hero.stats.fireResist !== 0) stats += `Fire Resist: ${hero.stats.fireResist}\n`;
    if (hero.stats.coldResist && hero.stats.coldResist !== 0) stats += `Cold Resist: ${hero.stats.coldResist}\n`;
    if (hero.stats.lightningResist && hero.stats.lightningResist !== 0) stats += `Lightning Resist: ${hero.stats.lightningResist}\n`;
    if (hero.stats.poisonResist && hero.stats.poisonResist !== 0) stats += `Poison Resist: ${hero.stats.poisonResist}\n`;
    if (hero.stats.arcaneResist && hero.stats.arcaneResist !== 0) stats += `Arcane Resist: ${hero.stats.arcaneResist}\n`;
    if (hero.stats.critDamage && hero.stats.critDamage !== 0) stats += `Crit Damage: ${hero.stats.critDamage.toFixed(2)}\n`;
    if (hero.stats.blockChance && hero.stats.blockChance !== 0) stats += `Block Chance: ${hero.stats.blockChance}\n`;
    if (hero.stats.thorns && hero.stats.thorns !== 0) stats += `Thorns: ${hero.stats.thorns}\n`;
    if (hero.stats.lifeSteal && hero.stats.lifeSteal !== 0) stats += `Life Steal: ${hero.stats.lifeSteal}\n`;
    if (hero.stats.lifePerKill && hero.stats.lifePerKill !== 0) stats += `Life Per Kill: ${hero.stats.lifePerKill}\n`;
    if (hero.stats.goldFind && hero.stats.goldFind !== 0) stats += `Gold Find: ${hero.stats.goldFind.toFixed(2)}\n`;
    if (hero.stats.magicFind && hero.stats.magicFind !== 0) stats += `Magic Find: ${hero.stats.magicFind.toFixed(2)}\n`;
    if (hero.stats.damageIncrease !== 0) stats += `Damage Increase: ${hero.stats.damageIncrease}\n`;
    if (hero.stats.critChance && hero.stats.critChance !== 0) stats += `Crit Chance: ${hero.stats.critChance.toFixed(2)}\n`;
    if (hero.stats.damageReduction && hero.stats.damageReduction !== 0) stats += `Damage Reduction: ${hero.stats.damageReduction}\n`;
    if (hero.stats.lifeOnHit && hero.stats.lifeOnHit !== 0) stats += `life On Hit: ${hero.stats.lifeOnHit}\n`;
    if (hero.stats.primaryResource && hero.stats.primaryResource !== 0) stats += `Primary Resource: ${hero.stats.primaryResource}\n`;
    if (hero.stats.secondaryResource && hero.stats.secondaryResource !== 0) stats += `Secondary Resource: ${hero.stats.secondaryResource}\n`;
