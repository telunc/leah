...
async function buildBotInfo(client) {
    ...
    fields.push({ name: 'Made by', value: 'Andy#7394', inline: true });
    ...
    fields.push({
        name: 'Donate',
        value: '[Patreon](https://www.patreon.com/leahbot)',
        inline: true
    });
    fields.push({
        name: 'Website',
        value: '[leah.moe](http://leah.moe/)',
        inline: true
    });
    fields.push({
        name: 'Support',
        value: '[Discord Server](https://discord.gg/etpF4PB)',
        inline: true
    });
    return fields;
}
